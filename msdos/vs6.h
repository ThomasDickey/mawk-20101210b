...
__declspec(noreturn) void bozo(const char *);
__declspec(noreturn) void mawk_exit(int);
__declspec(noreturn) void RE_panic(const char *);
__declspec(noreturn) void rt_error(const char *,...);
